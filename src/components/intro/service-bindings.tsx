    ...
    <section className="mt-8 mb-16">
      <div className="flex flex-col items-center gap-4 text-center">
        ...
        <p className="max-w-2xl leading-relaxed text-muted-foreground">
          Cloudflare Workers provides rich bindings to external services. All of these are available
          through <span className="font-semibold text-foreground">Miniflare</span> during local
          development, with the option of connecting directly to remote resources.
        </p>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col items-start text-left">
                  <h3 className="leading-none font-semibold tracking-tight">{binding.name}</h3>
